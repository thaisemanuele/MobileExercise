...
/**
 * A helper to connect through HTTPS and acquire the information from the links provided
 * @author Thais
 *
 */
public class ConnectionHelper {
	 ...
	 * @param url
	 * @return
	 * SUCCESS: Returns the string with the information retrieved from the server
	...
	/**
	 * Post the chargeback and lock/unlock request
	 * When posting lock/unlock requests, the JSON object is empty
	 * @param url
	 * @param json
	 * @return
	 * HTTP_OK: true
